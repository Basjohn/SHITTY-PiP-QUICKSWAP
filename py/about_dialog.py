...
from PySide6.QtWidgets import (
    QDialog, QVBoxLayout, QHBoxLayout, QLabel, QPushButton, QWidget, QApplication, QFrame
)
    ...
    def get_theme_styles(self, theme):
        ...
        dark_styles = """
            ...
            #aboutFrame {
                ...
                border-radius: 10px;
                background: rgba(51, 51, 51, 0.8);  /* Content area at 80% opacity */
                padding: 0px;
                margin: 0px;
            ...
            #titleBar {
                background-color: rgba(42, 42, 42, 0.9);  /* Title bar at 90% opacity */
                color: #ffffff;
        ...
        light_styles = """
            ...
            #aboutFrame {
                background: rgba(248, 248, 248, 0.8);  /* Content area at 80% opacity */
                border: 2px solid black;  /* Black border for light mode */
                border-radius: 10px;
                padding: 0px;
                margin: 0px;
                border-bottom-left-radius: 8px;
            ...
            #titleBar {
                background-color: rgba(240, 240, 240, 0.9);  /* Title bar at 90% opacity */
                color: #222222;
                border: 1.8px solid black;  /* Black border for light mode */
